                    ...
                    <nav class="flex items-center gap-2 sm:gap-4">
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="inline-flex items-center rounded-md border border-[#19140035] px-4 py-2 text-sm transition hover:border-black dark:border-[#3E3E3A] dark:hover:border-white" wire:navigate>Register</a>
                            @endif
                        @endauth
                    </nav>
                @endif
