...
{
    public function viewAny(User $user): bool { return $user->can(P::DEPARTMENTS_VIEW); }
    public function view(User $user, Department $department): bool { return $user->can(P::DEPARTMENTS_VIEW); }
