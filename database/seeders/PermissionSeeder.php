...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $role(\App\Models\Role::ROLE_SECRETARY)->syncPermissions($all->whereIn('name', [SchoolPermissions::DASHBOARD_GLOBAL, SchoolPermissions::STUDENTS_ALL, SchoolPermissions::STUDENTS_CREATE, SchoolPermissions::STUDENTS_UPDATE, SchoolPermissions::STUDENTS_IMPORT, SchoolPermissions::SCHOOLS_VIEW, SchoolPermissions::SCHOOLS_MANAGE, SchoolPermissions::DEPARTMENTS_VIEW, SchoolPermissions::CLASSROOMS_ALL, SchoolPermissions::GRADES_ALL, SchoolPermissions::HEALTH_VIEW, SchoolPermissions::HEALTH_MANAGE]));
